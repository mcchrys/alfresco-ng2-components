...
describe('ShareDataTableAdapter', () => {
    ...
    it('should setup rows and columns with constructor', () => {
        ...
        let adapter = new ShareDataTableAdapter(thumbnailService, contentService, schema);
    ...
    it('should set new columns', () => {
        ...
        let adapter = new ShareDataTableAdapter(thumbnailService, contentService, null);
    ...
    it('should reset columns', () => {
        let columns = [<DataColumn> {}, <DataColumn> {}];
        let adapter = new ShareDataTableAdapter(thumbnailService, contentService, columns);
    ...
    it('should put folders on top upon sort', () => {
        ...
        let adapter = new ShareDataTableAdapter(thumbnailService, contentService, [col]);
